...
from nonebot.adapters.cqhttp import Bot, GROUP, Event, PrivateMessageEvent, GroupMessageEvent, MessageSegment
from .data_source import Cards, meanings, global_config

CHAIN_REPLY = False if not global_config.chain_reply else global_config.chain_reply
